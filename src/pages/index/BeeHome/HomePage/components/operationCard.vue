<template>
  <div class="operation-card">
    ...
    <div
      class="op-item"
      @click="goSinglePage('beeFreeGift')"
    >
      <div class="img-content">
        <img
          :src="beeIcon.home_icon_free"
          alt="免费送礼"
        >
      </div>
      <p class="op-text">
    ...
    <div
      class="op-item"
      @click="$router.push('/discover/actionList')"
    >
      <div class="img-content">
        <img
          :src="beeIcon.home_icon_paction"
          alt="助力公益"
        >
      </div>
      <p class="op-text">
    ...
    >
      <div class="img-content">
        <img
          :src="beeIcon.home_icon_bee_robbing"
          alt="限量蜂抢"
        >
      </div>
      <p class="op-text">
    ...
    >
      <div class="img-content">
        <img
          :src="beeIcon.home_icon_endorsement"
          alt="代言集市"
        >
      </div>
      <p class="op-text">
    ...
    <div class="op-item" @click="$router.push({path: '/category/SecCategoryList',query: {target:'medical'}})">
      <div class="img-content">
        <img
  ...
  data() {
    return {
      beeIcon: {
        ...
        home_icon_free: require('@/assets/icon/home/index/home_icon_free@2x.png'),
